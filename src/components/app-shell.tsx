    ...
    <div className="min-h-screen">
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-64 border-r bg-card/80 p-5 backdrop-blur-xl md:block">
        <Link href="/dashboard" className="mb-10 flex items-center gap-3 font-bold">
          <span className="grid size-12 place-items-center overflow-hidden rounded-2xl border bg-white shadow-sm"><Image src="/orthoregistry-logo.png" alt="" width={1254} height={1254} className="size-full object-contain" /></span>
          OrthoRegistry
        </Link>
      ...
      <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b bg-background/80 px-4 backdrop-blur-xl md:hidden">
        <Link href="/dashboard" className="flex items-center gap-2 font-bold"><span className="grid size-10 place-items-center overflow-hidden rounded-xl border bg-white"><Image src="/orthoregistry-logo.png" alt="" width={1254} height={1254} className="size-full object-contain" /></span>OrthoRegistry</Link>
        <ThemeToggle />
      </header>
